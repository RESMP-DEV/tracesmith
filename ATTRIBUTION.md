...
| `tracesmith/extract/gemini.py` | 0xSero/ai-data-extraction | `extract_gemini.py` | `b7520c48b2bb46d5a0d3257e80ca1a59670d5e37` | MIT | Refactored to `Extractor` protocol; adds observed message IDs, token totals, lifecycle timestamps, and tool call/result summaries |
| `tracesmith/extract/opencode.py` | 0xSero/ai-data-extraction | `extract_opencode.py` | `b7520c48b2bb46d5a0d3257e80ca1a59670d5e37` | MIT | Refactored to `Extractor` protocol; both CLI + Tauri paths kept; project metadata now uses structured `directory`/`path.cwd` fields instead of content regexes |
