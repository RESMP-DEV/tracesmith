...
| `agent_trace_share/redact/rules/*.py` | RodriMora/agent-trace-redaction-methodology | `scripts/export_redacted_traces.py` (`Redactor` class) | `<pending>` | MIT | Split into modules by rule family |
