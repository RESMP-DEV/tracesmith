...
def test_write_manifest_roundtrip(tmp_path):
    ...
    export_summaries = {
        "messages": {"rows": 3, "dropped_no_assistant": 0, "dropped_filter": 0, "dropped_dedup": 0},
        "sharegpt": {"pairs": 2, "dropped_no_assistant": 0, "dropped_trailing_user": 0,
    ...
    # exported_messages mirrors the messages.jsonl row count.
...
def test_write_manifest_handles_missing_export_files(tmp_path):
    ...
    # No messages summary -> exported_messages defaults to 0.
